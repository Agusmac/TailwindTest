...
const Footer2 = () => {
  return (
   <>
    <footer className="footer p-10 md:px-60 bg-base-200 text-base-content border-t-2 grid-cols-2 md:grid-cols-none">
  <div>
...
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 md:px-52">
